...
public class RequestURLs {
    ...
    public static final String SERVER_HTTP_QUESTION_URL = "http://coms-309-034.class.las.iastate.edu:8080/question";
    public static final String SERVER_HTTP_SAVE_ANSWER_URL = "http://coms-309-034.class.las.iastate.edu:8080/answer";
    public static final String SERVER_HTTP_ANSWER_CHECKER_URL = "http://coms-309-034.class.las.iastate.edu:8080/question/answers";
    public static final String SERVER_HTTP_USER_ADD_POINTS_URL = "http://coms-309-034.class.las.iastate.edu:8080/users";
